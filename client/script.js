...
const myFunc =()=>{
    axios.get('http://localhost:3000/query-test/').then((res)=>{
        let qText = document.getElementById('query-text');
        qText.style.display = 'block';
        qText.style.backgroundColor = 'green';
        qText.textContent = res.data;
    })
}

document.getElementById('query-button').addEventListener('click',myFunc)
...
const createFood = () => {
  ...
  document.getElementById('food-button').addEventListener('click', (event)=>{
